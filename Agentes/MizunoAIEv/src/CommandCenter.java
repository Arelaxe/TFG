...
public class CommandCenter {
	...
	private boolean localization(){
		...
		if(!frameData.getCharacter(true).isFront()) reverseCount++;			
	 ...
	 */
	public int getMyHP(){
		if(this.playerNumber == true)return this.frameData.getCharacter(true).getHp();
		return this.frameData.getCharacter(false).getHp();
	}
	/**
	 * Gets the energy value of self.
	 */
	public int getMyEnergy(){
		if(this.playerNumber == true)return this.frameData.getCharacter(true).getEnergy();
		return this.frameData.getCharacter(false).getEnergy();
	}
	/**
	 * Gets the hit point of the opponent.
	 */
	public int getEnemyHP(){
		if(this.playerNumber == true)return this.frameData.getCharacter(false).getHp();
		return this.frameData.getCharacter(true).getHp();
	}
	/**
	 * Gets the energy value of the opponent.
	 */
	public int getEnemyEnergy(){
		if(this.playerNumber == true)return this.frameData.getCharacter(false).getEnergy();
		return this.frameData.getCharacter(true).getEnergy();
	}
	/**
	 * Gets self's x-coordinate.
	 */
	public int getMyX(){
		if(this.playerNumber==true)return this.frameData.getCharacter(true).getCenterX();
		return this.frameData.getCharacter(false).getCenterX();
	}
	/**
	 * Gets self's y-coordinate.
	 */
	public int getMyY(){
		if(this.playerNumber==true)return this.frameData.getCharacter(true).getCenterY();
		return this.frameData.getCharacter(false).getCenterY();
	}
	/**
	 * Gets the opponent's x-coordinate.
	 */
	public int getEnemyX(){
		if(this.playerNumber==true)return this.frameData.getCharacter(false).getCenterX();
		return this.frameData.getCharacter(true).getCenterX();
	}
	/**
	 * Gets the opponent's y-coordinate.
	 */
	public int getEnemyY(){
		if(this.playerNumber==true)return this.frameData.getCharacter(false).getCenterY();
		return this.frameData.getCharacter(true).getCenterY();
	}
	/**
	...
	public CharacterData getMyCharacter(){
		if(this.playerNumber == true)return this.frameData.getCharacter(true);
		else return this.frameData.getCharacter(false);
	}
	/**
	 * Gets the character data of the opponent.
	 */
	public CharacterData getEnemyCharacter(){
		if(this.playerNumber == true)return this.frameData.getCharacter(false);
		else return this.frameData.getCharacter(true);
	}
