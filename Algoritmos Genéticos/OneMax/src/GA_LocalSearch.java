...
public class GA_LocalSearch {
    ...
    static final int SIZE_LOCAL_SEARCH = 10;
    ...
    void produceNextGen() {
        ...
        while (newpopulation.size() < NUM_INDIVIDUALS
            ...
            for (i = 0; i < SIZE_LOCAL_SEARCH; i++){
                Individual old_child = child1;
                child1.flip(rand.nextInt());
                if (old_child.fitness() > child1.fitness()){
                    child1 = old_child;
                }
            }
